    ...
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        return scope.parse = function() {
          var data, defaultOptions, inputs, matChildren, options, propertyChild;
          data = {
          ...
          inputs.each(function(i, e) {
            ...
            if (!inputCard[0]) {
              if (key) {
                return defaultOptions[key] = inputScope.value;
              }
            } else {
              options[key] = inputCard.scope().parse();
              if (inputCard[1]) {
                return defaultOptions[key] = inputCard.get(1).scope().parse();
              }
            }
          });
    ...
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        if (!(cardData != null ? cardData.blockId : void 0)) {
          ...
          element.append(e);
          if ((ref4 = scope.input) != null ? ref4.defaultOptions : void 0) {
            defaultCardData = (ref5 = scope.$parent.card) != null ? (ref6 = ref5.options) != null ? ref6[(ref7 = scope.input) != null ? (ref8 = ref7.defaultOptions) != null ? ref8.result : void 0 : void 0] : void 0 : void 0;
            de = angular.element("<croset-component-input-" + scope.input.type + ">");
            de = $compile(de)(scope);
            de.appendTo(element);
          }
        }
        initialValue = (ref9 = scope.card) != null ? (ref10 = ref9.options) != null ? ref10[scope.input.options.result] : void 0 : void 0;
