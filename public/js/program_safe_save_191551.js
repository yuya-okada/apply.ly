...
crosetModule.value("GeneralComponents", {
  ...
  "$compile", function($compile) {
    return {
      ...
      scope: true,
      link: function(scope, element, attrs) {
        var e, initialValue, inputData, ref, ref1, ref2, ref3, ref4, ref5;
        element.empty();
        inputData = (ref = scope.$parent.card) != null ? (ref1 = ref.options) != null ? ref1[(ref2 = scope.input) != null ? (ref3 = ref2.options) != null ? ref3.result : void 0 : void 0] : void 0 : void 0;
        console.log(inputData, "yeah", scope, scope.$parent.card);
        if (!(inputData != null ? inputData.blockId : void 0)) {
          e = angular.element("<croset-component-input-" + scope.input.type + ">");
          e = $compile(e)(scope);
          e.appendTo(element);
        }
        initialValue = (ref4 = scope.card) != null ? (ref5 = ref4.cardOptions) != null ? ref5[scope.input.cardOptions.result] : void 0 : void 0;
