...
crosetModule.controller("EditorController", [
  "$scope", "ElementDatas", "$timeout", "$stateParams", "$injector", "$rootScope", "ProjectData", function($scope, ElementDatas, $timeout, $stateParams, $injector, $rootScope, ProjectData) {
    var dataStore;
