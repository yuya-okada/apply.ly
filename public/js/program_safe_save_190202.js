...
crosetModule.value("GeneralComponents", {
      ...
      link: function(scope, element, attrs) {
        ...
        return scope.parse = function() {
          ...
          inputs.each(function(i, e) {
            ...
            inputScope = $(e).scope();
            key = (ref1 = inputScope.input.cardOptions) != null ? ref1.result : void 0;
            if (!inputCard[0]) {
              if (key) {
              ...
              if (inputCard[1]) {
                return options[key] = inputCard.get(1).scope().parse();
              }
            }
          });
  ...
  "$compile", function($compile) {
    return {
      ...
      scope: true,
      link: function(scope, element, attrs) {
        var cardData, cardScope, de, defaultCardData, e, initialValue, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9;
        element.empty();
        cardData = (ref = scope.$parent.card) != null ? (ref1 = ref.cardOptions) != null ? ref1[(ref2 = scope.input) != null ? (ref3 = ref2.cardOptions) != null ? ref3.result : void 0 : void 0] : void 0 : void 0;
        ...
        if ((ref4 = scope.input) != null ? ref4.options : void 0) {
          defaultCardData = (ref5 = scope.$parent.card) != null ? (ref6 = ref5.cardOptions) != null ? ref6[(ref7 = scope.input) != null ? (ref8 = ref7.options) != null ? ref8.result : void 0 : void 0] : void 0 : void 0;
          de = angular.element("<croset-component-input-" + scope.input.type + ">");
          de = $compile(de)(scope);
          de.appendTo(element);
        }
        initialValue = (ref9 = scope.card) != null ? (ref10 = ref9.cardOptions) != null ? ref10[scope.input.cardOptions.result] : void 0 : void 0;
        scope.inputValue = initialValue || scope.input.cardOptions.defaultValue;
        return scope.value = "";
      }
    };
  }
