      ...
      link: function(scope, element, attrs) {
        ...
        return GetCardTemplate(function(template) {
          ...
          return $(component).draggable({
            ...
            stop: function(ev, ui) {
              var mat, mats, offset;
              console.log("ｲｪｱ", bottomBorder, modifyIcon, targetInput);
              if (bottomBorder) {
  ...
  "$compile", function($compile) {
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        scope.value = "";
        console.log(scope.input, scope.input.options.defaultValue, "いいえ。");
        return scope.inputDragStart = function() {
          ...
          e = $compile(e)(scope);
          e.appendTo(element);
          console.log(scope.input, scope.input.options.defaultValue, "はい。");
          return scope.inputValue = scope.input.options.defaultValue;
        };
      }
    };
  }
