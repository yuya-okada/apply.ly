...
crosetModule.value("GeneralComponents", {
  ...
  "$compile", function($compile) {
    return {
      ...
      scope: true,
      link: function(scope, element, attrs) {
        var cardData, cardScope, e, initialValue, inputData, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9;
        element.empty();
        ...
        console.log(inputData, "yeah", ((ref8 = scope.$parent.card) != null ? ref8.options : void 0) != null);
        if (!(inputData != null ? inputData.blockId : void 0)) {
