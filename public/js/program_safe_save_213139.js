...
crosetModule.value("GeneralComponents", {
  ...
  "$compile", function($compile) {
    return {
      ...
      scope: true,
      link: function(scope, element, attrs) {
        var cardData, cardScope, e, inputData, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7;
        element.empty();
        ...
        if (cardData != null ? cardData.blockId : void 0) {
          ...
          e = $compile(e)(scope);
          e.appendTo(element);
          inputData = (ref4 = scope.$parent.card) != null ? (ref5 = ref4.options) != null ? ref5[(ref6 = scope.input) != null ? (ref7 = ref6.options) != null ? ref7.result : void 0 : void 0] : void 0 : void 0;
          scope.inputValue = inputData || scope.input.options.defaultValue;
        }
        return scope.value = "";
      }
    };
    ...
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        scope.onchange = function() {
          var width;
          console.log(element.children("span")[0]);
          width = element.children("span")[0].offsetWidth;
          console.log(width, scope.inputValue, element.children("span").html());
          element.find("input").css("width", calculateWidth(width));
        };
