...
crosetModule.value("GeneralComponents", {
  ...
  "$compile", function($compile) {
    return {
      ...
      scope: true,
      link: function(scope, element, attrs) {
        var cardData, cardScope, e, initialValue, inputData, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9;
        element.empty();
        ...
        console.log(inputData, "yeah", scope.$parent.card);
        if (!(inputData != null ? inputData.blockId : void 0)) {
          e = angular.element("<croset-component-input-" + scope.input.type + ">");
          e = $compile(e)(scope);
          e.appendTo(element);
        }
        initialValue = (ref8 = scope.card) != null ? (ref9 = ref8.cardOptions) != null ? ref9[scope.input.cardOptions.result] : void 0 : void 0;
