  ...
  "$compile", function($compile) {
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        element.empty();
        cardData = (ref = scope.$parent.card) != null ? (ref1 = ref.cardOptions) != null ? ref1[(ref2 = scope.input) != null ? (ref3 = ref2.options) != null ? ref3.result : void 0 : void 0] : void 0 : void 0;
