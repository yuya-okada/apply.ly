...
Blockly.Msg.COLOUR_RGB_TITLE = "RGB";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "ループの次の反復処理を続行";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "条件を満たさない限り、";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "条件を満たす限り、";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST = "最初からサブリストを取得";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END = "端から #のサブリストを取得";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START = "# からサブディレクトリのリストを取得";
...
Blockly.Msg.LISTS_INDEX_OF_FIRST = "最初に見つかった項目を検索";
Blockly.Msg.LISTS_INDEX_OF_HELPURL = "https://github.com/google/blockly/wiki/Lists#getting-items-from-a-list";  // untranslated
Blockly.Msg.LISTS_INDEX_OF_LAST = "最後に見つかったアイテムを検索";
...
Blockly.Msg.MATH_CHANGE_TITLE = "%1 に加算 %2";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_LOWERCASE = "小文字に変換";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE = "タイトル ケースに変換";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE = "大文字に変換";
...
Blockly.Msg.VARIABLES_SET = "%1 に代入 %2";
