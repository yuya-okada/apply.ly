 ...
 */
Blockly.FieldElement.CHECKMARK_OVERHANG = 25;

/**
 * Android can't (in 2014) display "▾", so use "▼" instead.
 */
Blockly.FieldElement.ARROW_CHAR = goog.userAgent.ANDROID ? '\u25BC' : '\u25BE';

/**
 * Mouse cursor style when over the hotspot that initiates the editor.
 */
Blockly.FieldElement.prototype.CURSOR = 'default';
 ...
 * @private
 */
Blockly.FieldElement.prototype.value_ = '';
 ...
 * @private
 */
Blockly.FieldElement.prototype.imageElement_ = null;
 ...
 * @private
 */
Blockly.FieldElement.prototype.imageJson_ = null;

/**
 * Install this dropdown on a block.
 */
Blockly.FieldElement.prototype.init = function() {
  if (this.fieldGroup_) {
  ...
  this.arrow_.appendChild(document.createTextNode(this.sourceBlock_.RTL ?
      Blockly.FieldElement.ARROW_CHAR + ' ' :
      ' ' + Blockly.FieldElement.ARROW_CHAR));

  Blockly.FieldElement.superClass_.init.call(this);
  // Force a reset of the text to add the arrow.
  var text = "要素を選択";
  if (this.value_) {
    var element = CrosetBlock.get(this.value_);
    if (element) {
      text = element.name;
    } else {
      this.value_ = null
 ...
 * @private
 */
Blockly.FieldElement.prototype.showEditor_ = function() {
  
  this.setValue(null, "要素を選択");
  var that = this
  CrosetBlock.showSelectElementDialog(this.filter_, function(uuid, data) {
...
//     xy.x += Blockly.FieldElement.CHECKMARK_OVERHANG;
 ...
 */
Blockly.FieldElement.prototype.onItemSelected = function(menu, menuItem) {
 ...
 * @private
 */
Blockly.FieldElement.prototype.trimOptions_ = function() {
 ...
 */
Blockly.FieldElement.prototype.isOptionListDynamic = function() {
 ...
 */
Blockly.FieldElement.prototype.getOptions = function() {
 ...
 */
Blockly.FieldElement.prototype.getValue = function() {
  return this.value_;
};
 ...
 */
Blockly.FieldElement.prototype.setValue = function(newValue, newText) {
 ...
 * @private
 */
Blockly.FieldElement.prototype.render_ = function() {
  if (!this.visible_) {
    this.size_.width = 0;
    return;
  }
