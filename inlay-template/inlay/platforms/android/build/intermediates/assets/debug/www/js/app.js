...
.config(["$stateProvider", "$urlRouterProvider", "getDataFile", "generateController", "defaultScreen", function($stateProvider, $urlRouterProvider, getDataFile, generateController, defaultScreen) {
